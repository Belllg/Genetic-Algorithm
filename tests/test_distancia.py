...
class TestDistancia(unittest.TestCase):
    ...
    def test_known_distance(self) -> None:
        ...
        cep1: List[float] = [-23.550520, -46.633308]  # São Paulo
    ...
    def test_edge_case(self) -> None:
        ...
        cep1: List[float] = [0.0, 0.0]
        cep2: List[float] = [0.0001, 0.0001]  # Distância muito pequena
        resultado = distancia(cep1, cep2)
    ...
    def test_distance_poles(self) -> None:
        ...
        cep1: List[float] = [90.0, 0.0]  # Polo Norte
        cep2: List[float] = [-90.0, 0.0]  # Polo Sul
...
class TestDistanciaTotal(unittest.TestCase):
    def setUp(self):
        ...
        self.ceps = {
            'cep1': (10.0, 20.0),  # latitude 10°, longitude 20°
            'cep2': (12.0, 22.0),  # latitude 12°, longitude 22°
            'cep3': (14.0, 24.0),  # latitude 14°, longitude 24°
            'cep4': (16.0, 26.0)   # latitude 16°, longitude 26°
        }
